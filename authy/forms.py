...
class EditProfileForm(forms.ModelForm):
	...
	profile_info = forms.CharField(widget=forms.TextInput(), required=False)

	class Meta:
		model = Profile
		fields = ('picture', 'banner', 'first_name', 'last_name', 'location', 'url', 'profile_info','phone','college_id')
